...
import com.wormoscorp.ieaapp.EndUserChatModel;
import com.wormoscorp.ieaapp.EventChatAdapter;
import com.wormoscorp.ieaapp.FcmNotificationsSender;
import com.wormoscorp.ieaapp.explore_menu;
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    if(eventChatAdapter!=null){
                        eventChatRV.smoothScrollToPosition(position);
                    }
